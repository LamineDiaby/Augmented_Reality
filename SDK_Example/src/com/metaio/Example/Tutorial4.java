...
public class Tutorial4 extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try
		{
			...
			String filepath = AssetsManager.getAssetPath("Tutorial4/Assets4/TrackingData_MarkerlessFast.xml");
			
			boolean result = metaioSDK.setTrackingConfiguration(filepath); 
			MetaioDebug.log("Tracking data loaded: " + result); 
	        
			// Load all the geometries
			filepath = AssetsManager.getAssetPath("Tutorial4/Assets4/metaioman.md2");			
			if (filepath != null) 
			{

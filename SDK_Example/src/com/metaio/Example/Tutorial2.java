...
public class Tutorial2 extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try
		{
			...
			final String trackingConfigFile = AssetsManager.getAssetPath("Tutorial2/Assets2/TrackingData_MarkerlessFast.xml");
			
			final boolean result = metaioSDK.setTrackingConfiguration(trackingConfigFile); 
			MetaioDebug.log("Tracking data loaded: " + result); 
	        
			// Load all the geometries. First - Model
			final String modelPath = AssetsManager.getAssetPath("Tutorial2/Assets2/metaioman.md2");			
			if (modelPath != null) 
			{
			...
			final String imagePath = AssetsManager.getAssetPath("Tutorial2/Assets2/frame.png");
			if (imagePath != null)
			{
			...
			final String moviePath = AssetsManager.getAssetPath("Tutorial2/Assets2/demo_movie.3g2");
			if (moviePath != null)
			{
			...
			final String truckPath = AssetsManager.getAssetPath("Tutorial2/Assets2/truck/truck.obj");
			if (truckPath != null)
			{

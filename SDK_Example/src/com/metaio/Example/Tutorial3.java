...
public class Tutorial3 extends ARViewActivity 
{
	...
	{
		trackingConfigFile = AssetsManager.getAssetPath("Tutorial3/Assets3/TrackingData_Marker.xml");
	...
	{
		trackingConfigFile = AssetsManager.getAssetPath("Tutorial3/Assets3/TrackingData_PictureMarker.xml");
		MetaioDebug.log("Tracking Config path = "+trackingConfigFile);
	...
	{
		trackingConfigFile = AssetsManager.getAssetPath("Tutorial3/Assets3/TrackingData_MarkerlessFast.xml");
		MetaioDebug.log("Tracking Config path = "+trackingConfigFile);
	...
	protected void loadContents() 
	{
		try
		{
			...
			String metaioManModel = AssetsManager.getAssetPath("Tutorial3/Assets3/metaioman.md2");			

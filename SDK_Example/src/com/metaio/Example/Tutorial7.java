...
public class Tutorial7 extends ARViewActivity 
{
	...
	protected void loadContents() 
	{
		try 
		{
			...
			String filepath = AssetsManager.getAssetPath("Tutorial7/Assets7/tv.obj");
			if (filepath != null) 
			{
			...
			// Load screen
			filepath = AssetsManager.getAssetPath("Tutorial7/Assets7/screen.obj");
			if (filepath != null) 
			{
				...
				if (mScreen != null) 
				{
					...
					mScreen.setMovieTexture(AssetsManager.getAssetPath("Tutorial7/Assets7/sintel.3g2"));
					mScreen.startMovieTexture(true);
			...
			// Load chair
			filepath = AssetsManager.getAssetPath("Tutorial7/Assets7/stuhl.obj");
			if (filepath != null) 
			{
			...
			// Load metaio man
			filepath = AssetsManager.getAssetPath("Tutorial7/Assets7/metaioman.md2");
			if (filepath != null) 
			{

...
public class Tutorial6 extends ARViewActivity 
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		try
		{
			...
			FileInputStream fis = new FileInputStream(AssetsManager.getAssetPath("Tutorial6/Assets6/meow.mp3"));
	...
	protected void loadContents() 
	{
		...
		{
			// Load tiger model
			String tigerModelPath = AssetsManager.getAssetPath("Tutorial6/Assets6/tiger.md2");			
